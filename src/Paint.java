 ...
 * description: the program will calculate the gallons and quarts of paint are needed to paint the room.
 */
...
public class Paint {
    public static void main(String[] args) {
        ...
        System.out.println(gallons + " gallons and " + quarts + " quarts of paint is needed");
